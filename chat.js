...
function lky() {
	...
	else if(inputText.toLowerCase().indexOf("atom bombs")>-1||inputText.toLowerCase().indexOf("hiroshima")>-1||inputText.toLowerCase().indexOf("nagasaki")>-1){
	...
	else if(inputText.toLowerCase().indexOf("learning japanese")>-1||inputText.toLowerCase().indexOf("learning mandarin")>-1||inputText.toLowerCase().indexOf("nagasaki")>-1){
	...
	else if(inputText.toLowerCase().indexOf("banana notes")>-1||inputText.toLowerCase().indexOf("learning mandarin")>-1||inputText.toLowerCase().indexOf("nagasaki")>-1){
	...
	else if(inputText.toLowerCase().indexOf("met his wife")>-1||inputText.toLowerCase().indexOf("x")>-1||inputText.toLowerCase().indexOf("nagasaki")>-1){
