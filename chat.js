...
function lky() {
	...
	document.getElementById("answer").innerHTML="Your input is blank";      
		...
		else if(inputText.toLowerCase().indexOf("separated")>-1&&/\bmalaysia\b/.test(inputText.toLowerCase())||inputText.toLowerCase().indexOf("merger")>-1&&/\bmalaysia\b/.test(inputText.toLowerCase())){
	...
	else if(inputText.toLowerCase().indexOf("economy")>-1&&/\bcolonial\b/.test(inputText.toLowerCase())||inputText.toLowerCase().indexOf("economy")>-1&&/\bbritish\b/.test(inputText.toLowerCase())){
