...
function myFunction() {
	...
	document.getElementById("answer").innerHTML="Your input is blank";      
		...
		else if(inputText.toLowerCase().indexOf("socialism")>-1||inputText.toLowerCase().indexOf("")>-1){
			document.getElementById("answer").innerHTML=`Laski's lectures that I attended were my first introduction to the general theory of socialism, and I was immediately attracted to it. It struck me as manifestly fair that everybody in this world should be given an equal chance in life, that in a just and well-ordered society there should not be a great disparity of wealth between persons because of their position or status, or that of their parents. I made no distinction between different races and peoples. We were part of the British Empire, and I believed the British lived well at the expense of all their subjects.`;
		}
